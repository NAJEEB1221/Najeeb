...
$$/      $$/ $$/   $$/ $$/ $$/       $$/   $$/ $$/   $$/ $$/   $$/    $$/    $$$$$$/   $$$$$$/  $$/   $$/
\033[1;97m-----------------------------------------------
\033[1;91m➣ OWNER   : NAJEEB CREATION
\033[1;91m➣ Github  : NONR
\033[1;91m➣ GANG    : PK GANG
\033[1;91m➣ Youtube : NAJEEB TRICKER
\033[1;97m-----------------------------------------------"""
# titik #
def tik():
	titik = [".   ","..  ","... "]
...
def men():
	...
	if rana =="":
		...
		os.system('clear')
		print banner
		Mr.('[✓] Please Wait While Tool Is Updating')
		os.system('git pull origin master')
		Mr.('[✓] Tool Has Been Update Successfully')
		Mr.('[✓] Please Wait While Update Is Setting Up On Your Mobile Phone')
		time.sleep(3)
		os.Mr.('python2 jam.py')
	elif rana =="6":
		os.system('xdg-open https://www.facebook.com/100010703370182')
		menu()
	elif rana =="7":
		os.system('rm -rf login.txt')
		Mr.('[✓] Logged Out Successfully')
		os.system('python2 USMI.py')
	else:
		print "[!] Wrong Input"
		men()
...
def crack_menu():
	...
	if crm =="":
        ...
        Mr.('[✓] Total Friends: '+str(len(id)))
        time.sleep(0.5)
	Mr ('[✓] The Process Has Been Started.')
	time.sleep(0.5)
        Mr.('[!] To Stop Process Press CTRL Then Z')
        time.sleep(0.5)
        print (47*"-")
	...
	p.map(main, id)
	print "\033[1;97m----------------------------------------------"
	Mr.('[✓] Process Has Been Completed.')
	Mr.('\033[1;97m[✓] Checkpoint IDS Has Been Saved.')
	xx = str(len(oks))
...
def idfromfriend():
	...
	try:
		...
		z=json.loads(r.text)
		Mr.('[✓] Getting Friends Numeric IDs...')
		print"--------------------------------------"
